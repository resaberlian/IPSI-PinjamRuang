...
<!--===============================================================================================-->
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>/assets/<?php echo base_url(); ?>/assets/vendor/bootstrap/css/bootstrap.min.css">
<!--===============================================================================================-->
    ...
    <div class="wrap-login100">
      ...
      <form action="<?php echo base_url() ?>index.php/User/create" method="post">
        ...
        <div class="text-center p-t-12">
          ...
          <a class="txt2" href="<?php echo base_url() ?>index.php/Login/" >Log in
          </a>
        </div>
