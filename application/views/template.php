...
<body>
        ...
        <nav id="sidebar" class="">
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="side-text" id="menu1" style="padding:1rem ;">
                    <?php
	                ...
	                ?>
                        <li class="active" >
                            <a class="" href="<?php echo base_url() ?>index.php/dashboard/index/admin">
                                   <i class="fa big-icon fa-home icon-wrap" style="color:black"></i>
                                   <span class="mini-click-non" style="color:black">Beranda</span>
                                </a>
                        </li>
                        <li>
                            <a class="has-arrow" aria-expanded="false"><i class="fa big-icon fa-table icon-wrap" style="color:black"></i> <span class="mini-click-non" style="color:black">Tabel Data</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                            <li><a title="Data table" href="<?php echo base_url() ?>index.php/Admin"><i class="fa fa-th sub-icon-mg" aria-hidden="true" style="color:black"></i> <span class="mini-sub-pro" style="color:black">Admin</span></a></li>
                            <li><a title="Data Table" href="<?php echo base_url() ?>index.php/Kategori"><i class="fa fa-th sub-icon-mg" aria-hidden="true" style="color:black"></i> <span class="mini-sub-pro" style="color:black">Kategori</span></a></li>
                            <li><a title="Data Table" href="<?php echo base_url() ?>index.php/Ruang"><i class="fa fa-th sub-icon-mg" aria-hidden="true" style="color:black"></i> <span class="mini-sub-pro" style="color:black">Ruang</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="" href="<?php echo base_url() ?>index.php/History" aria-expanded="false"><i class="fa big-icon fa-history icon-wrap" style="color:black"></i> <span class="mini-click-non"  style="color:black">Riwayat</span></a>
                        ...
                        <li class="active">
                            ...
                            <i class="fa big-icon fa-home icon-wrap"  style="color:black"></i>
                        <span class="mini-click-non "  style="color:black">Ruangan dalam</span>
                            </a>
                        </li>
                        <li >
                        <a class="" href="<?php echo base_url() ?>index.php/dashboard/index/outdoor" aria-expanded="false"><i class="fa big-icon fa-home icon-wrap"  style="color:black"></i> <span class="mini-click-non"  style="color:black">Ruangan terbuka</span></a>
                        </li>
                        <li>
                        <a class="" href="<?php echo base_url() ?>index.php/History/index" aria-expanded="false"><i class="fa big-icon fa-history icon-wrap"  style="color:black"></i> <span class="mini-click-non"  style="color:black">Riwayat</span></a>
                        </li>
                        <?php
		                    } else if ($this->session->userdata('level')=='sarpra') {?>
                        
                        <li> 
                            <a class="" href="<?php echo base_url() ?>index.php/Peminjaman" aria-expanded="false"  ><i class="fa big-icon fa-line-chart icon-wrap" style="color:black"></i> <span class="mini-click-non" style="color:black">Peminjaman</span></a>
    ...
    border-bottom-right-radius: 20px; background: #fff;"><i class="fa fa-search"></i></button>
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                                        <div class="header-right-info">
                                            ...
                                            <?php if($this->session->userdata('level')=='siswa'){
                                               ...
                                               <?php } else if ($this->session->userdata('level')=='sarpra'){?>
                                                <li class="nav-item">
            ...
            <?php
			if($this->session->userdata('nama_lvl') == 'admin' || $this->session->userdata('nama_lvl') == 'sarpra'){
			?>
